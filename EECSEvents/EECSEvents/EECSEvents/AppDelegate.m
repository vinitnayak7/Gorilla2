...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    viewController = [[SplashViewController alloc] initWithNibName:@"SplashViewController" bundle:nil];
...
{
    [self.window.rootViewController presentViewController:cnt animated:true completion:^{
